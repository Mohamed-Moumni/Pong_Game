        ...
        <Wrap align={"center"}>
            <Stack align={"center"} spacing={"10px"} style={{ position: 'absolute', zIndex: 1 }} >
                <Stack spacing={"1px"} align={"center"} fontFamily={"visbyRound"}>
                    <Avatar boxSize={{ base: "40px", xl: "65px" }} name={username} src={avatar.includes("http") ? avatar : "http://localhost:3000/public/users/imgs/" + avatar} border="1px solid #D9D9D9" marginBottom={2} style={{ backgroundColor: '#5B6171', fontSize: '15px' }} />
            ...
            <Stack align={"center"} spacing={"10px"} style={{ position: 'relative', zIndex: 0 }} marginLeft={{ base: "90px", lg: "130px", "2xl": "180px" }}>
                <Stack spacing={"1px"} align={"center"} fontFamily={"visbyRound"}>
                    <Avatar boxSize={{ base: "40px", xl: "65px" }} name={other} src={otherAvatar.includes("http") ? otherAvatar : "http://localhost:3000/public/users/imgs/" + otherAvatar} border="1px solid #D9D9D9" marginBottom={2} style={{ backgroundColor: '#5B6171', fontSize: '15px' }} />
